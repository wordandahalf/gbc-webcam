...
const m64282fp_pio_clock_period_us = 1_000_000.0 / @as(comptime_float, m64282fp_pio_clock_frequency);
pub const m64282fp_pio_clock_periods_per_exposure: comptime_int =
    std.math.divExact(comptime_float, m64282fp.exposure_time_increment_us, m64282fp_pio_clock_period_us) catch {
        compileErrorFmt(
            "illegal configuration: PIO clock period of {e:.4}us does not evenly divide exposure increment {}us",
            .{ m64282fp_pio_clock_period_us, m64282fp.exposure_time_increment_us }
        );
    };
